const ProjectItem = ({ bg, name, description, hyperlink }) => {
  return (
    <div className="border-solid border-4 border-cyan-500 relative flex justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-2xl group hover:bg-gradient-to-r from-cyan-400 to-pink-400">
      <img
        src={bg}
        alt="/"
